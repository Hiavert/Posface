...
Route::middleware('auth')->group(function () {
    ...
    // Cambié los nombres para evitar conflicto con profile.edit duplicado
    Route::get('/profile', [ProfileController::class, 'edit'])->name('profile.edit.main');
    Route::patch('/profile', [ProfileController::class, 'update'])->name('profile.update.main');
    Route::delete('/profile', [ProfileController::class, 'destroy'])->name('profile.destroy.main');

    // Tareas documentales con permisos
    ...
    // Perfil con permisos y nombres únicos (sin conflicto)
